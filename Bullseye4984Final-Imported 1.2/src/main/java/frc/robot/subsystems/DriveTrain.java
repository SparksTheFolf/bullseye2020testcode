...
public class DriveTrain extends Subsystem {
 ...
 // private CANSparkMax leftDriveMotor = new CANSparkMax(Constants.MOTOR_LEFT_FRONT_ID, MotorType.kBrushless);
//  private CANSparkMax leftDriveMotor1 = new CANSparkMax(Constants.MOTOR_LEFT_BACK_ID, MotorType.kBrushless);
  // ***this motor is unplugged
  //private CANSparkMax rightDriveMotor = new CANSparkMax(Constants.MOTOR_RIGHT_FRONT_ID, MotorType.kBrushless);
 // private CANSparkMax rightDriveMotor1 = new CANSparkMax(Constants.Motor_RIGHT_BACK_ID, MotorType.kBrushless);
public DriveTrain(){
