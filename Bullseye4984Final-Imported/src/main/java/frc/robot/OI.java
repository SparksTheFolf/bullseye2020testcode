...
public class OI {
  ...
  private Joystick operatorJoystickLeft = new Joystick(RobotMap.OPERATOR_JOYSTICK_LEFT);
  private Joystick operatorJoystickRight  = new Joystick(RobotMap.OPERATOR_JOYSTICK_RIGHT);
  private Joystick buttonBoard = new Joystick(RobotMap.BUTTON_BOARD);

 

  Button rocketCargo1 = new JoystickButton(buttonBoard, RobotMap.ROCKET_CARGO_1_BUTTON);
  Button rocketCargo2 = new JoystickButton(buttonBoard, RobotMap.ROCKET_CARGO_2_BUTTON);
  Button rocketCargo3 = new JoystickButton(buttonBoard, RobotMap.ROCKET_CARGO_3_BUTTON);

  Button rocketHatch1 = new JoystickButton(buttonBoard, RobotMap.ROCKET_HATCH_1_BUTTON);
  Button rocketHatch2 = new JoystickButton(buttonBoard, RobotMap.ROCKET_HATCH_2_BUTTON);
  Button rocketHatch3 = new JoystickButton(buttonBoard, RobotMap.ROCKET_HATCH_3_BUTTON);

  Button shipCargo = new JoystickButton(buttonBoard, RobotMap.SHIP_CARGO_BUTTON);
  Button shipHatch = new JoystickButton(buttonBoard, RobotMap.SHIP_HATCH_BUTTON);

  Button humanCargo = new JoystickButton(buttonBoard, RobotMap.HUMAN_CARGO_BUTTON);
  Button humanHatch = new JoystickButton(buttonBoard, RobotMap.HUMAN_HATCH_BUTTON);

  Button groundCargo = new JoystickButton(buttonBoard, RobotMap.GROUND_CARGO_BUTTON);
  Button groundHatch = new JoystickButton(buttonBoard, RobotMap.GROUND_HATCH_BUTTON);

  Button Climb1 = new JoystickButton(operatorJoystickLeft, RobotMap.CLIMB_1_BUTTON);
  Button Climb2 = new JoystickButton(operatorJoystickLeft, RobotMap.CLIMB_2_BUTTON);
