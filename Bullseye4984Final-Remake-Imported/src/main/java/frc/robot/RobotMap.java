...
public class RobotMap {
  ...
  public static final int RH1_WRIST = -605;
  ...
  public static final int RH2_ELBOW = -450;
  public static final int RH2_WRIST = -375;
  ...
  public static final int SH_WRIST = -640;

  public static final int SHIP_CARGO_BUTTON = 4;
  public static final int SC_ELEVATOR = 185;
  ...
  public static final int HH_SHOULDER = -975;
  public static final int HH_ELBOW = -670;
  public static final int HH_WRIST = -630;
